...
public class PasswordController {
    ...
    public String changePassword(
        ...
        if (doctor.getPasswordHash() == null
                || passwordForm.getOldPassword() == null
                || !BCrypt.checkpw(passwordForm.getOldPassword(), doctor.getPasswordHash())) {
        ...
        doctor.setPasswordHash(BCrypt.hashpw(passwordForm.getNewPassword(), BCrypt.gensalt()));
